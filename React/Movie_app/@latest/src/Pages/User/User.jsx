...
export default function User() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-900">Favourite Movies</h2>
            ...
            {favMovies.map((movie) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <button 
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-600 hover:text-white transition-colors duration-200 font-medium"
                  >
    ...
    //     </div>
    //     <button className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Remove From Favourite</button>
    //   </div>
    //     ))
    //   }
    // </div>
